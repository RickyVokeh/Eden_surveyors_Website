...
(function() {
    ...
    const Environment = {
        ...
        getBasePath: function() {
            ...
            if (hostname === 'edensurvey.co.ke' || 
                hostname === 'www.edensurvey.co.ke' ||
        ...
        getPlatform: function() {
            ...
            if (host === 'edensurvey.co.ke' || host === 'www.edensurvey.co.ke') return 'Production';
            return 'Unknown';
        },
...
const ActiveLink = {
    highlight: function() {
        ...
        document.querySelectorAll('nav a, .nav-menu a, .footer-col a').forEach(link => {
            ...
            // Handle other pages with precise matching
...
// SPA navigation support: detect route changes
if (typeof urlRouter !== 'undefined') {
    // If your router exposes an event when routes change
    urlRouter.on('routeChange', function() {
        ActiveLink.highlight();
    });
}

// Fallback: patch pushState for routers that use history API
(function() {
    ...
    window.addEventListener('popstate', ActiveLink.highlight);
})();
    // =========================================
    // 6. INITIALIZE
    // =========================================
